...
You can download the precomputed libraries here: https://drive.google.com/drive/folders/16BtjLV74uk7A9ZAgGJoo5kOc5aUSpx3p?usp=drive_link
...
### Quick Start
run the visualization tool: python visualization_v2.py
